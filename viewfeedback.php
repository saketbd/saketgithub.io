...
<tr><td><a class="z" href="insrtlaptop.php">Change Laptops</a></td></tr>
</table>
</td></tr>
</table>
</th>
		...
		$rid=0;	
			 $rid2=mysql_query($query2);
				$pagesize=3;
					...
					for($i=0;$i<$num;$i++)
      				{
	echo"<tr><th>".$rid[$i]['id']."</th><th>".$rid[$i]['user']."</th><th>".$rid[$i]['email']."</th><th>".$rid[$i]['comment']."</th></tr>";
}
}
echo"</table>";
