...
$query2="select * from reg";
	...
	echo"<tr><th>".$rid[$i]['id']."</th><th>".$rid[$i]['first_name']."</th><th>".$rid[$i]['last_name']."</th><th>".$rid[$i]['email_id']."</th><th>".$rid[$i]['password']."</th><th>".$rid[$i]['gender']."</th><th>".$rid[$i]['address']."</th><th>".$rid[$i]['city']."</th><th>"
