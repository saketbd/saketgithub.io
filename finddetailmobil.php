...
<form action="addcartm.php" method="post">
<?php
$as=0;
include("connect.php");
$a=$_REQUEST['a'];
...
if($s=mysql_fetch_array($r))
{
	...
	<tr><td><u><b>For Buy the laptop plz fill the detail</b></u></td></tr>
	<tr><th>Enter No of Item<input type='text' name='t1' value='' style=padding:6px; width:200px; /></th></tr></table>";
$_SESSION['id']=$a;
}
