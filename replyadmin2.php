...
$query2="select * from sndfdbk";
	...
	<a href=replyadmin2.php?a=".$rid[$i]['id'].">Reply</a></th></tr>";
}
}
?>
...
$re=$_REQUEST['a'];
include("connect.php");
$query3=mysql_query("select * from sndfdbk where id='$re'");
if($r=mysql_fetch_array($query3))
{
?>
<form action="replyadmin3.php" method="post" onSubmit="return val()">
<table align="center" border='10' height='300' width='300'>
<tr><th>user</th><th><input type='text' name='t1' value="<?php echo $r['user'] ; ?>" disabled=disabled>
<input type='hidden' name='t1' value="<?php echo $r['user'] ; ?>" ></th></tr>
<tr><th>email</th><th><input type='text' name='t2'  value="<?php echo $r['email'] ; ?>" disabled=disabled>
<input type='hidden' name='t2' value="<?php echo $r['email'] ; ?>"></th></tr>
<tr><th>comment</th><th><input type='text' name='t3'  value="<?php echo $r['comment'] ; ?>" disabled=disabled>
<input type='hidden' name='t3' value="<?php echo $r['comment'] ; ?>"></th></tr>
<tr><th>Reply</th><th><textarea name='t4'></textarea></th></tr> 
<tr><th colspan=2><input type='submit' value='Reply'></th></tr>
</table></form>";
