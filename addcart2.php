...
$cname=$_SESSION['cnmae'];
$mno=$_SESSION['mno'];
$price=$_SESSION['price'];
$total=$_SESSION['total'];
$item=$_SESSION['item'];
$image=$_SESSION['image'];
mysql_query("insert into orde values('','$fname','$phone','$gender','$da','$cname','$mno','$price','$total','$item','$email','$image')")or die ("error=".mysql_error());
echo"<h1>Your order is booked</h1>";
?>
</form>
</div><!--main1-->
<hr class="g" />
