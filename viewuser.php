...
$query2="select * from reg";
			 ...
			 $rid2=mysql_query($query2);
				$pagesize=3;
					...
					if(ExecPaging($query2,$parameter,$pagesize))
						$rid=ExecPaging($query2,$parameter,$pagesize,"viewuser.php");
					else
						$NoMake=1;
	...
	.$rid[$i]['ph_no']."</th><th>" ?> <img src="<?php echo $path ; ?>" height="100" width="100"  /><?php echo "</th></tr>";
}
}
echo"</table>";
