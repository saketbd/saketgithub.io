...
<img class="aa" src="image/samsang/samsung_galaxy_s_iv.jpg">
<h1 class="cc">Galaxy s4</h1>
<img class="bb" src="image/samsang/nokia lumia 920.jpg">
<h1 class="cc">Nokia lumia 920</h1>
<img class="bb" src="image/samsang/samsung galaxy s3.jpg">
<h1 class="cc">Samsung galaxy s3</h1>
<img class="bb" src="image/samsang/sony.jpg">
<h1 class="cc">Sony xperia</h1>
<img class="bb" src="image/samsang/samsung galaxy grand.jpg">
<h1 class="cc">Galaxy grand</h1>
<img class="dd" src="image/laptop/sony vaio.jpg">
<h1 class="da">Sony vaio</h1>
<img class="ee" src="image/laptop/sony vaio1.jpg">
<h1 class="da">Sony vaio</h1>
<img class="ee" src="image/laptop/hp1.jpg">
<h1 class="add">hp</h1>
<img class="ee" src="image/laptop/acer.jpg">
<h1 class="add">Acer</h1>
<img class="ee" src="image/laptop/acer1.jpg">
<h1 class="add">Acer</h1>
</div><!--main1-->
<hr class="g" />
<div class="p"><!--p-->
<form name="f" action="#">
<table class="q">
<tr><td><marquee onMouseOver="stop()" onMouseOut="start()"><img class="r" src="image/125034-image.jpg" name="a" onMouseOver="val()"
onMouseOut="val1()" />
<img class="r" src="image/laptop/sony.jpg" name="b" />
<img class="r" src="image/laptop/hp.jpg" name="c" />
<img class="r" src="image/laptop/acer  computer laptop.jpg" name="d" />
<img class="r" src="image/sony-ericsson-xperia.jpg" name="e"/></marquee></td></tr>
</table>
</form>
</div><!--p-->
<hr class="g" />
