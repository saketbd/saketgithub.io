...
<th onMouseOver="show2('one')" onMouseOut="hide('one')"><a class="f" href="contact.php">ALL USER DETAILS</a>
...
<th onMouseOver="show2('sec')" onMouseOut="hide('sec')"><a class="f" href="product.php">ORDER DETAILS</a>
...
<th onMouseOver="show2('thrd')" onMouseOut="hide('thrd')"><a class="f" href="about.html">FEEDBACK</a>
...
<tr><td><a class="z" href="">Reply</a></td></tr>
...
include("connect.php");
$del=$_REQUEST['a'];
mysql_query("delete from fedbak where id='$del'");
 	$query2="select * from fedbak";
			$rid=0;
			 $rid2=mysql_query($query2);
				$pagesize=3;
					...
					if(ExecPaging($query2,$parameter,$pagesize))
						$rid=ExecPaging($query2,$parameter,$pagesize,"viewfeedback.php");
					else
						$NoMake=1;
	...
	<a href=deletefeedback2.php?a=".$rid[$i]['id'].">Delete</a></th></tr>";
}
}
echo"</table>";
...
<tr>
<th><a class="f" href="admin.php">HOME</a></th>
<th onMouseOver="show2('for')" onMouseOut="hide('for')"><a class="f" href="contact.php">ALL USER DETAILS</a>
<table id="for" class="abc">
<tr><td><a class="z" href="viewuser.php">View User</a></td></tr>
<tr><td><a class="z" href="deleteuser.php">Delete User</a></td></tr>
</table>
</th>
<th onMouseOver="show2('fiv')" onMouseOut="hide('fiv')"><a class="f" href="product.php">ORDER DETAILS</a>
<table id="fiv" class="abc">
<tr><td><a class="z" href="vieworder.php">View All Orders</a></td></tr>
<tr><td><a class="z" href="deleteorder.php">Delete All Orders</a></td></tr>
</table>
</th>
<th onMouseOver="show2('six')" onMouseOut="hide('six')"><a class="f" href="about.html">FEEDBACK</a>
