...
$query2="select * from insrtlap";
			 ...
			 $rid2=mysql_query($query2);
				$pagesize=3;
					...
					if(ExecPaging($query2,$parameter,$pagesize))
						$rid=ExecPaging($query2,$parameter,$pagesize,"insrtlaptop.php");
					else
						$NoMake=1;
	...
	<th><a href=deletelap.php?a=".$rid[$i]['id'].">Delete</a></th>
	<th><a href=Updatelap.php?a=".$rid[$i]['id'].">Update</a></th>
	</tr>";
}
}
echo"</table>";
	...
	include("connect.php");
$aa=$_REQUEST['a'];
$se=mysql_query("select * from insrtlap where id='$aa'");
if($sa=mysql_fetch_array($se))
{
	?>
	<h1 class="l1">UPDATE LAPTOP</h1>
<form name="f" action="Updatelap1.php" method="post" onSubmit="return val()" enctype="multipart/form-data">
<table class="l2">
