...
<tr>
<th colspan="3">
<a href="viewmoreproduct.php?a=laptop">More Laptop</a>
</th>
</tr>
<tr>
<?php
...
while($s1=mysql_fetch_array($r1))
{
	...
	echo"<th align=center><table align=center><tr><th>";?><a href="finddetailmobil.php?a=<?php echo $s1['id'] ; ?>"> <img src="<?php echo $path1 ; ?>" 
...
<tr>
<th colspan="3">
<a href="viewmoreproduct.php?a=mobile">More Mobile</a>
</th>
</tr></table>
</div><!--main1-->
<hr class="g" />
