...
<form action="senduserfeedback1.php" method="post" name="f" onSubmit="return val()">
<table class="jjj">
<tr><td>User</td><td><input class="laa" type="text" name="t1"></td></tr>
<tr><td>Email</td><td><input class="laa" type="text" name="t2" value="<?php echo $_SESSION['email'] ; ?>" disabled=disabled><input class="laa" type="hidden" name="t2" value="<?php echo $_SESSION['email'] ; ?>"></td></tr>
<tr><td>Comment</td><td><textarea class="kkk" name="t3"></textarea></td></tr>
<tr><td colspan="2"><input class="mmm" type="submit" value="send"></td></tr>
</table>
</form>
</div><!--main1-->
<hr class="g" />
