...
$query2="select * from orde";
			 ...
			 $rid2=mysql_query($query2);
				$pagesize=3;
					...
					if(ExecPaging($query2,$parameter,$pagesize))
						$rid=ExecPaging($query2,$parameter,$pagesize,"vieworder.php");
					else
						$NoMake=1;
					...
					<th>Total</th><th>Item</th><th>Email</th><th>image</th></tr>";
					for($i=0;$i<$num;$i++)
      				{
	...
	.$rid[$i]['email']."</th><th>" ?> <img src="<?php echo $path ; ?>" height="100" width="100"  /><?php echo "</th></tr>";
}
}
echo"</table>";
