...
$query2="select * from reg where email_id='$aaa'";
			 ...
			 if($s=mysql_fetch_array($rid2))
			 {
                    ...
                    echo"<table border=10 width=100% height=300 style=color:white>
					<tr><th>Id</th><th>image</th><th>Action</th></tr>";
	
	$path="upload/".$s['image'];
	echo"<tr><th>".$s['id']."</th><th>" ?> <img style="height:200; width:250px;" src="<?php echo $path ; ?>" height="100" width="100"  /><?php echo "</th>
	<th><a href=chnguserimg1.php?a=".$s['id'].">Upload</a></th></tr>";
}
echo"</table>";
		
?>
<h1 class="l1">CHANGE IMAGE</h1>
<form action="chnguserimg2.php" method="post" name="f" onSubmit="return val()" enctype="multipart/form-data">
<table class="jj">
<tr><td>Image</td><td><input class="la" type="file" name="file"></td></tr>
<tr><td colspan="2"><input class="mm" type="submit" value="Upload"></td></tr>
</table>
</form>
</div><!--main1-->
<hr class="g" />
